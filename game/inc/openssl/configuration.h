/*
 * WARNING: do not edit!
 * Generated by configdata.pm from ../src/nssl-3.2.0-5a1db6e780.clean/Configurations/common0.tmpl, ../src/nssl-3.2.0-5a1db6e780.clean/Configurations/unix-Makefile.tmpl
 * via Makefile.in
 *
